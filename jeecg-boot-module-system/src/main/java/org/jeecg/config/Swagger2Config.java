...
public class Swagger2Config implements WebMvcConfigurer {
    ...
    // 定义分隔符,配置Swagger多包
    private static final String SOLITOR = ";";
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                ...
                .apis(basePackage("org.jeecg.modules" + SOLITOR + "org.kunze.diansh" + SOLITOR + "org.alipay"))
    ...
    private static Function< Class< ? >, Boolean > handlerPackage(final String basePackage) {
        return input -> {
            // 循环判断匹配
            for (String strPackage : basePackage.split(SOLITOR)) {
    ...
    /***
     * oauth2配置 需要增加swagger授权回调地址 http://localhost:8888/webjars/springfox-swagger-ui/o2c.html
     * 
     * @return
     */
    @Bean
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                // //大标题
                .title("哄哄到家后台服务API接口文档")
                // 版本号
                .version("1.0")
                // .termsOfServiceUrl("NO terms of service")
                // 描述
                .description("哄哄到家后台API接口")
                // 作者
                .contact("JEECG团队").license("The Apache License, Version 2.0")
