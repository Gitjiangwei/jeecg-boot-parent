...
public class SendStatusStatistics {
    public static void main(String[] args) {
        try {
            ...
            String SecretId = "AKID5WR5SYkzUuBDyUGPmtjKL7oEOIySxkW5";
            String SecretKey = "ghSwA9sKVSWO291gDaGSN2Vifb4g290e";
            ...
            req.setStartDateTime(Long.valueOf(startdatetime));
            /* 结束时间，yyyymmddhh 需要拉取的截止时间，精确到小时
             * 注：EndDataTime 必须大于 StartDateTime */
            String enddatatime = "2019071123";
            req.setEndDataTime(Long.valueOf(enddatatime));
